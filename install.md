...
接下来我们从[alephium release](https://github.com/alephium/alephium/releases)页面上下载最新版本(当前最新版本为0.9.0)，下载完成功后开始创建配置文件:
...
```sh
$ 切换到之前下载的`alephium-0.9.0.jar`目录下
...
2021-09-12 13:27:41,637 [main]          INFO  o.a.app.BootUp                         - Build info: name: alephium-app, scalaVersion: 2.13.5, sbtVersion: 1.3.10, commitId: 5bb6610cd0118f6407dab5364baebea2282275a0, branch: 5bb6610cd0118f6407dab5364baebea2282275a0, releaseVersion: 0.9.0
